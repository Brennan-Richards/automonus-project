...
class Account(models.Model):
    ...
    available_balance = models.DecimalField(max_digits=18, decimal_places=2, default=0, null=True)
    current_balance = models.DecimalField(max_digits=18, decimal_places=2, default=0, null=True)
